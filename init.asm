...
printint(int fd, int xx, int base, int sgn)
{
 ...
 1fb:	0f b6 92 68 04 00 00 	movzbl 0x468(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 2c8:	ff 24 85 10 04 00 00 	jmp    *0x410(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 32d:	75 15                	jne    344 <printf+0xfa>
          s = "(null)";
 32f:	be 08 04 00 00       	mov    $0x408,%esi
